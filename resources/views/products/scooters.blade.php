...
<body>
@include('layout.nav')
<div class="banner" style="width=100%; position: relative; height: 40vh; margin-top: 75px; background-image: url('https://github.com/Alex11520/img/blob/main/img/scooter_desktop.jpg?raw=true'); background-size: cover; background-position: center;">
            ...
            <div class="product-card">
                ...
                <div class="product-info">
                    ...
                    <div class="product-buttons">
                        <button data-id="{{ $scooter->prodNo }}" data-type="bike">Add to cart</button>
                        @if ($scooter->size)
