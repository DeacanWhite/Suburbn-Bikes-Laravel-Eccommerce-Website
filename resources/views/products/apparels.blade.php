...
<body>
@include('layout.nav')
<div class="banner" style="width=100%; position: relative; height: 40vh; margin-top: 75px; background-image: url('https://github.com/Alex11520/img/blob/main/img/appareal_desktop.jpeg?raw=true'); background-size: cover; background-position: center;">
    <div style="display: flex; height: 100%; align-items: center; justify-content: flex-end; padding-right: 10%; padding-bottom: 5%;">
            ...
            <div class="product-card">
                ...
                <div class="product-info">
                    ...
                    <div class="product-buttons">
                        <button data-id="{{ $apparel->prodNo }}" data-type="bike">Add to cart</button>
                        @if ($apparel->size)
