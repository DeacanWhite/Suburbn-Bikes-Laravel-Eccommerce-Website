...
<div>
    @if(session('success'))
        <div class="alert alert-success" style="position: absolute; width: fit-content; top: 10%;left: 45%;;z-index: 1000; text-align: center; ">
            {{ session('success') }}
        </div>
    @endif
    @yield('content')
...
{{--    @if(session('success'))--}}
{{--        <div class="alert alert-success" style="position: absolute; width: fit-content; top: 9%;left: 43%;;z-index: 1000; text-align: center; ">--}}
{{--            {{ session('success') }}--}}
{{--        </div>--}}
{{--    @endif--}}
